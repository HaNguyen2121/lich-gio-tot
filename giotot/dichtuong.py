"""Dịch tượng + ý nghĩa 64 quẻ và 6 lục thú (nguồn: lich.vutrungu.com).

Dùng cho tooltip học Dịch. Mỗi quẻ kèm "hao" = 6 hào từ DƯỚI lên trên
('1'=dương/liền, '0'=âm/đứt).
"""
...
def mo_ta(ten_que):
    """Dịch tượng của một quẻ (dict ten/chi_tuong/y_nghia/hao) hoặc None."""
    return DICH_TUONG.get(chuan_hoa(ten_que))


def mo_ta_luc_thu(ten):
    """Ý nghĩa một lục thú (dict ten/nguhanh/y_nghia) hoặc None."""
    return LUC_THU.get(chuan_hoa(ten))
